...
BEGIN
    ...
    DROP POLICY IF EXISTS "School admins can access their school data" ON schools;
    
    -- Drop policies for school_admins table
    DROP POLICY IF EXISTS "School admins can manage school_admins" ON school_admins;
    
    -- Drop policies for teachers table
    DROP POLICY IF EXISTS "School admins can manage teachers" ON teachers;
    DROP POLICY IF EXISTS "Teachers can access their school data" ON teachers;
    
    -- Drop policies for students table
    DROP POLICY IF EXISTS "School admins can manage students" ON students;
    DROP POLICY IF EXISTS "Students can access their own data" ON students;
    
    -- Drop policies for classes table
    DROP POLICY IF EXISTS "School admins can manage classes" ON classes;
    DROP POLICY IF EXISTS "Teachers can access their classes" ON classes;
    
    -- Drop policies for subjects table
    DROP POLICY IF EXISTS "School admins can manage subjects" ON subjects;
    
    -- Drop policies for class_subjects table
    DROP POLICY IF EXISTS "School admins can manage class_subjects" ON class_subjects;
    
    -- Drop policies for homework table
    DROP POLICY IF EXISTS "School admins can manage homework" ON homework;
    DROP POLICY IF EXISTS "Teachers can manage homework" ON homework;
    DROP POLICY IF EXISTS "Students can view their homework" ON homework;
    
    -- Drop policies for homework_submissions table
    DROP POLICY IF EXISTS "School admins can view homework submissions" ON homework_submissions;
    DROP POLICY IF EXISTS "Teachers can view homework submissions" ON homework_submissions;
    DROP POLICY IF EXISTS "Students can submit homework" ON homework_submissions;
    DROP POLICY IF EXISTS "Students can view their submissions" ON homework_submissions;
    
    -- Drop policies for attendance table
    DROP POLICY IF EXISTS "School admins can manage attendance" ON attendance;
    ...
    -- Drop policies for exams table
    DROP POLICY IF EXISTS "School admins can manage exams" ON exams;
    DROP POLICY IF EXISTS "Teachers can manage exams" ON exams;
    
    -- Drop policies for exam_results table
    DROP POLICY IF EXISTS "School admins can view exam results" ON exam_results;
    DROP POLICY IF EXISTS "Teachers can manage exam results" ON exam_results;
    DROP POLICY IF EXISTS "Students can view their exam results" ON exam_results;
    
    -- Drop policies for fees table
    DROP POLICY IF EXISTS "School admins can manage fees" ON fees;
    
    -- Drop policies for fee_payments table
    DROP POLICY IF EXISTS "School admins can view fee payments" ON fee_payments;
    
    -- Drop policies for notifications table
    DROP POLICY IF EXISTS "School admins can manage notifications" ON notifications;
    
    -- Drop policies for holidays_events table
    DROP POLICY IF EXISTS "School admins can manage holidays_events" ON holidays_events;
...
DROP TABLE IF EXISTS holidays_events CASCADE;
...
DO $$
BEGIN
    RAISE NOTICE 'School Management System schema created successfully!';
    RAISE NOTICE 'All tables, policies, indexes, and triggers have been set up.';
END $$;
